...
gcloud run deploy nightshift-webhook \
  ...
  --set-env-vars "APPROVED_REPOSITORY=karthik7271/nightshift,USE_GOOGLE_CLOUD=1,GOOGLE_CLOUD_PROJECT=${PROJECT_ID},GITHUB_APP_CLIENT_ID=Iv23li6pKOo2oVhF7q8N,GITHUB_APP_PRIVATE_KEY_PATH=/var/run/secrets/nightshift/github-app.pem,GEMINI_MODEL=gemini-3-flash-preview" \
